...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest(
            assemblyName: "KoreForge.RestApi.External.Sample",
        ...
        var expected = new DiagnosticResult(DiagnosticDescriptors.ExternalCannotReferenceOtherLayers)
            .WithSpan(1, 1, 1, 1)
            .WithArguments("KoreForge.RestApi.External.Sample", "Domain.Cases");
...
namespace KoreForge.RestApi.Domain.Sample;
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest(
            assemblyName: "KoreForge.RestApi.Domain.Sample",
        ...
        var expected = new DiagnosticResult(DiagnosticDescriptors.DomainCannotReferenceDisallowedLayers)
            .WithSpan(1, 1, 1, 1)
            .WithArguments("KoreForge.RestApi.Domain.Sample", "Client.Cases");
        test.ExpectedDiagnostics.Add(expected);
...
namespace KoreForge.RestApi.Internal.Sample;
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest(
            assemblyName: "KoreForge.RestApi.Internal.Sample",
    ...
    [assembly: InternalsVisibleTo(""KoreForge.RestApi.Internal.Sample"")]
    ...
    ");
        ...
        var expected = new DiagnosticResult(DiagnosticDescriptors.InternalCannotReferenceExternal)
            .WithSpan(1, 1, 1, 1)
            .WithArguments("KoreForge.RestApi.Internal.Sample", "External.Cases");
        test.ExpectedDiagnostics.Add(expected);
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest("KoreForge.RestApi.Domain.Sample");
        test.TestCode = source;
...
namespace KoreForge.RestApi.Client.Sample;
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest("KoreForge.RestApi.Client.Sample");
        test.TestCode = source;
        await test.RunAsync();
    }
}
