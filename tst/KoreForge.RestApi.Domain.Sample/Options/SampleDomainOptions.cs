...
namespace KoreForge.RestApi.Domain.Sample.Options;
...
{
    public const string ConfigurationSection = "Domains:" + KoreForge.RestApi.External.Sample.SampleConstants.ApiName;
