...
namespace KoreForge.Web.Authorization.Tests.Core;
...
public class RolesAuthorizationFilterTests
{
    ...
    private sealed class TrackingCondition : KoreForge.Web.Authorization.Core.IContextAuthorizationCondition
    {
